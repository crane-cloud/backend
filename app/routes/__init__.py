...
api.add_resource(OrganisationDetailView,
                 '/organisations/<string:org_id>', endpoint='organisation')

# Organisation Members routes
api.add_resource(
    OrgMemberView, '/organisations/<string:organisation_id>/members', endpoint='org_members')

# Organisation Admins routes
api.add_resource(
    OrgAdminView, '/organisations/<string:organisation_id>/admins', endpoint='org_admins')
...
api.add_resource(NamespaceDetailView,
                 '/namespaces/<string:id>', endpoint='namespace')
